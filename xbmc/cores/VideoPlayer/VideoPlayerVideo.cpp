...
void CVideoPlayerVideo::CalcFrameRate()
{
  ...
  CLog::Log(LOGINFO,"%s DVD_TIME_BASE:%f frameduration:%f framerate:%f m_iFrameRateCount:%f", __FUNCTION__, DVD_TIME_BASE, frameduration, framerate, m_iFrameRateCount);
  ...
  else if (fabs(m_fStableFrameRate / m_iFrameRateCount - framerate) <= MAXFRAMERATEDIFF)
  {
    ...
    m_iFrameRateCount++;
    CLog::Log(LOGINFO,"%s frameduration:%f framerate:%f m_fFrameRate:%f m_fStableFrameRate:%f m_iFrameRateCount:%f", __FUNCTION__, frameduration, framerate, m_fFrameRate, m_fStableFrameRate, m_iFrameRateCount);
